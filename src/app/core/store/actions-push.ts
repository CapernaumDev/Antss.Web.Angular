...
export const setInitialAppData = createAction('[Server Push] Initial App Data', props<{ appData: AppData }>());
...
export const userCreated = createAction('[Server Push] User Created', props<{ user: UserListItem }>());

export const userUpdated = createAction('[Server Push] User Updated', props<{ user: UserListItem }>());
