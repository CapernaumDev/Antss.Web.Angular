...
describe('Reducers', () => {
  ...
  it('PushActions.ticketCreated adds to ticketlist items when the item does not already exist', () => {
    ...
    const state = Reducers(
      testState,
      PushActions.ticketCreated({ ticket: ticket, boardColumnIndex: 2, initiatedByUserId: 2 })
    );
  ...
  it('PushActions.ticketStatusUpdatedByServer updates ticketlist item status', () => {
    ...
    const state = Reducers(
      testState,
      PushActions.ticketStatusUpdatedByServer({ ticket: updatedTicket, boardColumnIndex: 2, initiatedByUserId: 2 })
    );
  ...
  it('PushActions.ticketStatusUpdatedByServer updates ticket board moving item between columns', () => {
    ...
    const state = Reducers(
      testState,
      PushActions.ticketStatusUpdatedByServer({ ticket: updatedTicket, boardColumnIndex: 0, initiatedByUserId: 2 })
    );
