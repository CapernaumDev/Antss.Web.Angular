...
describe('AppEffects', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'abcde/123', component: MockComponent }])],
      providers: [
        Effects,
  ...
  describe('loginSuccess', () => {
    ...
    it('should redirect to the redirectUrl', inject(
      [Router],
  ...
  describe('createTicketSuccess$', () => {
    it('should navigate to previous url if it is set in store', inject(
      [Router],
      fakeAsync((router: Router) => {
    ...
    it('should navigate to ticket list if previous url is not set in store', inject(
      [Router],
      fakeAsync((router: Router) => {
  ...
  describe('createOrUpdateUserSuccess', () => {
    it('should be called on create user success', inject(
      [Router],
      fakeAsync((router: Router) => {
        const spy = spyOn(router, 'navigateByUrl').and.stub();
    ...
    it('should be called on update user success', inject(
      [Router],
      fakeAsync((router: Router) => {
        const spy = spyOn(router, 'navigateByUrl').and.stub();
    ...
    it('should redirect to user list', inject(
      [Router],
      fakeAsync((router: Router) => {
        const spy = spyOn(router, 'navigateByUrl').and.stub();
        actions$ = of(ApiActions.updateUserSuccess);
  ...
  describe('updateTicketStatusRequested$', () => {
    it('should call updateTicketStatus with the transformed parameters', fakeAsync(() => {
      ...
      actions$ = of(
        UiActions.ticketStatusUpdatedByUser({ ticket: ticket, boardColumnIndex: 222, newTicketStatusId: 2 })
      );
